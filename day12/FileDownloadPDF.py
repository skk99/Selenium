...
def firefox_setup():
    ...
    options.set_preference("browser.helperApps.neverAsk.saveToDisk", "application/pdf")          #Check mimetype in the second arg for a particular file from https://www.sitepoint.com/mime-types-complete-list/
    options.set_preference("browser.download.manager.showWhenStarting", False)      #for ignoring the ask window
    ...
    options.set_preference("pdfjs.disabled", True)          #for pdf download directly
